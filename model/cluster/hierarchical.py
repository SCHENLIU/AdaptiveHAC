...
def _hc_cut(n_clusters, children, n_leaves, distance=None, threhold = 1):
...
class AdaptiveAgglomerativeClustering(BaseEstimator, ClusterMixin):
    """
    ...
    def __init__(self, n_clusters=2, affinity="euclidean",
                 ...
                 linkage='ward', pooling_func='deprecated', threhold = 1):
    ...
    def fit(self, X, y=None):
        ...
        if compute_full_tree:
            self.labels_, self.n_clusters = _hc_cut(self.n_clusters, self.children_,
                                   self.n_leaves_, distance=distances, threhold=1-self.threhold)
        else:
...
class FeatureAgglomeration(AdaptiveAgglomerativeClustering, AgglomerationTransform):
    ...
    def fit(self, X, y=None, **params):
        ...
        return AdaptiveAgglomerativeClustering.fit(self, X.T, **params)
